...
public class DeteccionRepositoryJdbc extends RepositorioJdbc implements DeteccionRepository {
     ...
     * sumo una. El que sí podría multiplicar —{@code f}, cuya unicidad sólo está garantizada para
     * la versión abierta ({@code ficha_vigente_uq} es parcial)— se queda en {@link
     * #DESDE_EL_PADRON}, y eso lo fija una prueba.
     */
