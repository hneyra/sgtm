...
@DisplayName("Capa web — GET /api/v1/transito/papeletas/busqueda")
class BusquedaDePapeletasControllerTest {
    ...
    void estadoDeDeudaPresenteActivaSoloPendientes() throws Exception {
        mvc.perform(
                        get("/api/v1/transito/papeletas/busqueda")
                                .param("papeleta", "PT-0001")
    ...
    @Test
    @DisplayName("sin estadoDeDeuda, soloPendientes queda en falso")
    void sinEstadoDeDeudaSoloPendientesQuedaEnFalso() throws Exception {
        mvc.perform(get("/api/v1/transito/papeletas/busqueda")).andReturn();

        assertThat(repositorio.ultimoCriterio.soloPendientes()).isFalse();
    }
