...
| RF-009 | Mantener las tablas de valuación por ejercicio: aranceles, valores unitarios de edificación y depreciación ‹de solo lectura por HTTP: el arancel se carga por lote contra un conjunto de parámetros antes de sellarlo; los valores unitarios y la depreciación son catálogos nacionales desde ADR-0017; la de depreciación la publica el proceso batch desde `V57`, y la de valores unitarios en cuanto tenga su segunda firma y sus cuatro regiones (GOB-03, H-14)› | `aranceles`, `valores_unitarios`, `depreciacion` |
