...
| RF-009 | Mantener las tablas de valuación por ejercicio: aranceles, valores unitarios de edificación y depreciación ‹de solo lectura por HTTP: el arancel se carga por lote contra un conjunto de parámetros antes de sellarlo; los valores unitarios y la depreciación son catálogos nacionales desde ADR-0017 y los publica el proceso batch en cuanto sus tablas ganen la dimensión que les falta (GOB-03, H-14 y H-15)› | `aranceles`, `valores_unitarios`, `depreciacion` |
