 ...
 *  las 134 opciones del manual. La pastilla cuenta lo que pide acción. */
export type Destino = {
  k: string;
  label: string;
  nota: string;
...
export const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'predios', label: 'Predios', nota: '18,412 en el padrón', icono: ICO.lupa },
      { k: 'mapa', label: 'Mapa catastral', nota: 'Buscar por manzana y lote', icono: ICO.mapa },
      { k: 'territorio', label: 'Territorio', nota: '5 sectores · 2,184 vías', icono: ICO.rejilla },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'padron', label: 'Contribuyentes', nota: '62,418 en el padrón', icono: ICO.persona },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'deteccion', label: 'Detección', nota: '3,418 omisos · 618 vehículos', icono: ICO.lupaMas, pastilla: '4,036' },
      { k: 'programas', label: 'Programas', nota: '1 en ejecución', icono: ICO.calendario },
      { k: 'actas', label: 'Actas de inspección', nota: 'Campo y gabinete', icono: ICO.portapapeles, pastilla: '12' },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'padron', label: 'Papeletas', nota: '12,844 en el ejercicio', icono: ICO.tabla, pastilla: '8,662', tono: 'warn' },
      { k: 'internamiento', label: 'Internamiento', nota: 'Depósito municipal', icono: ICO.vehiculo, pastilla: '118', tono: 'bad' },
      { k: 'procesos', label: 'Procesos', nota: 'Valores, número, documentos', icono: ICO.engranajeMas },
      { k: 'codigos', label: 'Códigos de tránsito', nota: '342 del reglamento', icono: ICO.hojaLineas },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'lista', label: 'Expedientes', nota: '812 del ejercicio', icono: ICO.tabla, pastilla: '214', tono: 'bad' },
      { k: 'cuis', label: 'Cuadro CUIS', nota: '284 tipificadas', icono: ICO.hojaLineas },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'convenios', label: 'Convenios', nota: 'Fraccionar y seguir', icono: ICO.hojaLineas, pastilla: '141', tono: 'warn' },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'lista', label: 'Valores', nota: '4,182 emitidos', icono: ICO.hoja, pastilla: '412', tono: 'bad' },
      { k: 'emision', label: 'Emisión', nota: 'Individual y masiva', icono: ICO.mas },
      { k: 'prescripcion', label: 'Prescripción', nota: 'Declarar y extinguir', icono: ICO.reloj, pastilla: '88', tono: 'warn' },
    ],
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'importacion', label: 'Importación', nota: 'Valores firmes por recibir', icono: ICO.descarga, pastilla: '4', tono: 'warn' },
      { k: 'lista', label: 'Expedientes', nota: '4,182 en cartera', icono: ICO.tabla, pastilla: '388', tono: 'bad' },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'lista', label: 'Solicitudes', nota: 'Los tres trámites', icono: ICO.edificio, pastilla: '164', tono: 'warn' },
  ...
  },
  {
    ...
    destinos: [
      ...
      { k: 'accesos', label: 'Accesos', nota: 'Quién puede hacer qué', icono: ICO.rejillaAcc, pastilla: '3', tono: 'bad' },
