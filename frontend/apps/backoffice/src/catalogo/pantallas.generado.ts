...
export const PANTALLAS: Readonly<Record<string, EstructuraDePantalla>> = {
  ...
  portal: {
    ...
    tabla: {
      ...
      cols: ['', 'Concepto', 'Periodo', 'Vencimiento', 'Insoluto S/', 'Interés S/', 'Total S/'],
      num: [4, 5, 6],
    ...
    acciones: ['Descargar estado de cuenta', 'Pagar S/ 640.06'],
  },
  ficha_urbana: {
    id: 'ficha_urbana',
    mod: 'Catastro',
          ...
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['P — PRINCIPAL', 'S — SECUNDARIA', 'C — COCHERA'],
              },
              {
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['99 — NO ESPECIFICADO', '01 — CON CERTIFICADO', '02 — SIN CERTIFICADO'],
              },
              {
            ...
            campos: [
              {
                ...
                label: 'Departamento',
                t: 'sel',
                opts: ['PIURA', 'LIMA', 'TUMBES', 'LAMBAYEQUE'],
              },
              {
                clave: 'provincia',
                label: 'Provincia',
                t: 'sel',
                opts: ['SULLANA', 'PIURA', 'TALARA', 'PAITA'],
              },
              {
                clave: 'distrito',
                label: 'Distrito',
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['Zona 1', 'Zona 2', 'Zona 3', 'Zona 4'],
              },
              {
                clave: 'referencia',
                label: 'Referencia',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['SUNARP — SULLANA', 'SUNARP — PIURA'],
              },
              {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Condición',
                t: 'sel',
                opts: ['TITULAR', 'CÓNYUGE', 'COPROPIETARIO', 'REPRESENTANTE'],
              },
              {
                clave: 'estadoCivil',
                label: 'Estado civil',
                t: 'sel',
                opts: ['SOLTERO(A)', 'CASADO(A)', 'VIUDO(A)', 'DIVORCIADO(A)', 'CONVIVIENTE'],
              },
              {
                clave: 'fechaDesde',
                label: 'Fecha desde',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'UCA',
                t: 'sel',
                opts: ['99 — NO ESPECIFICADO', '01 — VIVIENDA', '02 — COMERCIO', '03 — DEPÓSITO'],
              },
            ],
          },
          {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['MUY BUENO', 'BUENO', 'REGULAR', 'MALO'],
              },
              {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['VIVIENDA', 'COMERCIO', 'DEPÓSITO', 'SERVICIOS'],
              },
              {
                clave: 'fechaDeInicio',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['01 — CASA HABITACIÓN', '02 — COMERCIO', '03 — INDUSTRIA', '04 — SERVICIOS'],
              },
              {
                clave: 'frecuenciaDeRecoleccion',
                label: 'Frecuencia de recolección',
                t: 'sel',
                opts: ['DIARIA', 'INTERDIARIA', 'DOS VECES POR SEMANA', 'SEMANAL'],
              },
              {
                clave: 'frecuenciaDeBarrido',
                label: 'Frecuencia de barrido',
                t: 'sel',
                opts: ['DIARIA', 'INTERDIARIA', 'SEMANAL'],
              },
              {
                clave: 'frontisMl',
                label: 'Frontis (ml)',
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['INTERIOR', 'ESQUINA', 'FRENTE A PARQUE', 'FRENTE A VÍA PRINCIPAL'],
              },
              {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['ASFALTADA', 'AFIRMADA', 'TROCHA', 'ADOQUINADA'],
              },
              {
    ...
    acciones: ['Nuevo', 'Modificar', 'Deshacer', 'Imprimir', 'Guardar'],
  },
  ficha_economica: {
    id: 'ficha_economica',
    mod: 'Catastro',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['A — Activa', 'I — Inactiva', 'P — Pendiente', 'X — Anulada'],
          },
          {
    ...
    acciones: ['Nuevo', 'Guardar', 'Imprimir'],
  },
  ficha_bienes: {
    id: 'ficha_bienes',
    mod: 'Catastro',
    ...
    acciones: ['Distribuir valor', 'Guardar'],
  },
  ficha_rural: {
    id: 'ficha_rural',
    mod: 'Catastro',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Valle / sector',
        t: 'sel',
        opts: ['Todos', 'Valle del Chira', 'Cieneguillo', 'Miguel Checa', 'Lancones'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Valle / sector',
            t: 'sel',
            opts: ['Valle del Chira', 'Cieneguillo', 'Miguel Checa', 'Lancones'],
          },
          {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['BAJO RIEGO', 'SECANO'],
          },
          {
            clave: 'cultivoPredominante',
            label: 'Cultivo predominante',
            t: 'sel',
            opts: ['ARROZ', 'BANANO', 'MANGO', 'LIMÓN', 'MAÍZ AMARILLO', 'ALGODÓN'],
          },
          {
    ...
    acciones: ['Calcular', 'Guardar', 'Imprimir ficha rural'],
  },
  consulta_fichas: {
    id: 'consulta_fichas',
    mod: 'Catastro',
    ...
    acciones: ['Exportar Excel', 'Conciliar seleccionadas'],
  },
  actualizacion_catastro: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Sector',
        t: 'sel',
        opts: ['Todos', '01', '02', '03', '04', '05'],
      },
      {
        clave: 'tipoDeActualizacion',
        label: 'Tipo de actualización',
        t: 'sel',
        opts: ['INDIVIDUAL', 'MASIVA POR SECTOR', 'POR NOTIFICACIÓN', 'POR FISCALIZACIÓN'],
      },
    ],
    tabs: [
      {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'ECS',
                t: 'sel',
                opts: ['01 — MUY BUENO', '02 — BUENO', '03 — REGULAR', '04 — MALO'],
              },
              {
                clave: 'edc',
                label: 'EDC',
                t: 'sel',
                opts: ['01 — TERRENO SIN CONSTRUIR', '02 — CONSTRUIDO', '03 — EN CONSTRUCCIÓN'],
              },
            ],
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'UCA',
                t: 'sel',
                opts: ['01 — CERCO', '02 — PORTÓN', '03 — TANQUE', '99 — NO ESPECIFICADO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Nuevo', 'Guardar', 'Imprimir', 'Quitar'],
  },
  ficha_contribuyente_reporte: {
    ...
    reporte: {
      ...
      cols: ['Unidad', 'Identificación', 'Uso / clase', 'Condición', 'Deuda S/'],
      num: [4],
    },
  },
  calles: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Tipo de vía',
        t: 'sel',
        opts: ['Todos', 'AVENIDA', 'CALLE', 'JIRÓN', 'PASAJE', 'CARRETERA', 'PROLONGACIÓN'],
      },
      {
        clave: 'sector',
        label: 'Sector',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Tipo de vía',
            t: 'sel',
            opts: ['AVENIDA', 'CALLE', 'JIRÓN', 'PASAJE', 'CARRETERA', 'PROLONGACIÓN'],
          },
          {
            clave: 'nombre',
            label: 'Nombre',
    ...
    tabla: {
      ...
      cols: ['Código', 'Tipo Vía', 'Nombre', 'Sector', 'Zona', 'Arancel S/ m²', 'Estado'],
      num: [5],
    },
    acciones: ['Nuevo', 'Guardar', 'Inactivar'],
  },
  sectores: {
    id: 'sectores',
    mod: 'Catastro',
    ...
    filtros: [
      {
        ...
        label: 'Ejercicio',
        t: 'sel',
        opts: ['2026', '2025', '2024', '2023', '2022', '2021', '2020'],
      },
      {
        clave: 'via',
        label: 'Vía',
      ...
      },
      {
        ...
        label: 'Zona',
        t: 'sel',
        opts: ['Todas', 'Zona 1', 'Zona 2', 'Zona 3', 'Zona 4'],
      },
    ],
    tabla: {
      title: 'Aranceles vigentes 2026',
      cols: ['Vía', 'Cuadra desde', 'Cuadra hasta', 'Zona', 'Arancel S/ m²', 'Variación vs. 2025'],
      num: [1, 2, 4, 5],
      note: 'Aranceles aprobados por el Ministerio de Vivienda, Construcción y Saneamiento para el ejercicio 2026.',
    },
    acciones: ['Importar tabla del año', 'Guardar'],
  },
  valores_unitarios: {
    ...
    filtros: [
      {
        ...
        label: 'Material (MEP)',
        t: 'sel',
        opts: ['CONCRETO', 'LADRILLO', 'ADOBE', 'QUINCHA', 'MADERA'],
      },
      {
        clave: 'uso',
        label: 'Uso',
        t: 'sel',
        opts: ['CASA HABITACIÓN', 'TIENDAS Y OFICINAS', 'INDUSTRIA'],
      },
    ],
    tabla: {
      title: 'Depreciación por antigüedad y estado — ladrillo, casa habitación',
      cols: ['Antigüedad', 'Muy bueno %', 'Bueno %', 'Regular %', 'Malo %'],
      num: [1, 2, 3, 4],
    },
  },
  contribuyentes: {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['NATURAL', 'JURÍDICA', 'SUCESIÓN INDIVISA', 'SOCIEDAD CONYUGAL'],
              },
              {
              ...
              },
              {
                ...
                label: 'Estado',
                t: 'sel',
                opts: ['A — ACTIVO', 'I — INACTIVO', 'B — BAJA', 'F — FALLECIDO', 'N — NO HABIDO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Nuevo', 'Modificar', 'Imprimir', 'Guardar'],
  },
  predios_rentas: {
    id: 'predios_rentas',
    mod: 'Rentas · Registro',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Condición',
        t: 'sel',
        opts: ['Todas', 'Afecto', 'Inafecto', 'Exonerado', 'Transferido'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['PROPIETARIO ÚNICO', 'COPROPIETARIO', 'POSEEDOR', 'SUCESIÓN'],
          },
          {
            clave: 'dePropiedad',
            label: '% de propiedad',
    ...
    acciones: ['Nuevo', 'Guardar', 'Ver ficha catastral'],
  },
  predial_individual: {
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['INSCRIPCIÓN', 'DESCARGO', 'RECTIFICATORIA', 'ANUAL MECANIZADA'],
      },
      {
        ...
        campos: [
          {
            ...
            t: 'sel',
            opts: ['NO APLICA', 'PENSIONISTA — 50 UIT', 'ADULTO MAYOR NO PENSIONISTA — 50 UIT'],
          },
          {
            clave: 'nDeResolucion',
        ...
        campos: [
          {
            ...
            label: 'Modalidad',
            t: 'sel',
            opts: ['AL CONTADO', 'FRACCIONADO EN 4 CUOTAS'],
          },
          {
    ...
    acciones: ['Buscar', 'Simular', 'Calcular'],
  },
  predial_masivo: {
    id: 'predial_masivo',
    mod: 'Rentas · Registro',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Alcance',
            t: 'sel',
            opts: ['TODO EL PADRÓN', 'POR SECTOR', 'POR RANGO DE CÓDIGO', 'SOLO OBSERVADOS'],
          },
          {
            clave: 'sector',
            label: 'Sector',
    ...
    tabla: {
      ...
      cols: ['Etapa', 'Registros', 'Monto S/', 'Observados', 'Estado'],
      num: [1, 2, 3],
    ...
    acciones: ['Simular', 'Ver observados', 'Ejecutar proceso'],
  },
  declaracion_jurada: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Tipo',
        t: 'sel',
        opts: ['Todas', 'INSCRIPCIÓN', 'DESCARGO', 'RECTIFICATORIA', 'ANUAL MECANIZADA'],
      },
    ],
    secciones: [
      {
    ...
    acciones: ['Vista previa', 'Imprimir HR / PU / PR'],
  },
  arbitrios: {
    id: 'arbitrios',
    mod: 'Rentas · Registro',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Uso',
        t: 'sel',
        opts: ['CASA HABITACIÓN', 'COMERCIO', 'INDUSTRIA', 'SERVICIOS', 'TERRENO SIN CONSTRUIR'],
      },
    ],
    tabla: {
    ...
    acciones: ['Recalcular', 'Emitir cuponera de arbitrios'],
  },
  transferencia_predio: {
    ...
    acciones: ['Validar deuda del transferente', 'Registrar transferencia'],
  },
  alcabala: {
    id: 'alcabala',
    mod: 'Rentas · Registro',
    ...
    acciones: ['Liquidar', 'Generar orden de pago', 'Imprimir liquidación'],
  },
  vehiculos: {
    id: 'vehiculos',
    mod: 'Rentas · Registro',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Marca',
                t: 'sel',
                opts: ['TOYOTA', 'HYUNDAI', 'NISSAN', 'KIA', 'SUZUKI', 'CHEVROLET'],
              },
              {
                clave: 'modelo',
                label: 'Modelo',
              ...
              },
              {
                ...
                label: 'Carrocería',
                t: 'sel',
                opts: ['SEDÁN', 'HATCHBACK', 'FURGÓN', 'TOLVA', 'CISTERNA'],
              },
              {
                clave: 'combustible',
                label: 'Combustible',
                t: 'sel',
                opts: ['GASOLINA', 'DIÉSEL', 'GLP', 'GNV', 'ELÉCTRICO', 'HÍBRIDO'],
              },
              {
                clave: 'categoria',
                label: 'Categoría',
                t: 'sel',
                opts: ['M1', 'M2', 'M3', 'N1', 'N2', 'N3', 'L5'],
              },
            ],
          },
          {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Forma de adquisición',
                t: 'sel',
                opts: ['COMPRA-VENTA', 'REMATE', 'DONACIÓN', 'HERENCIA', 'IMPORTACIÓN'],
              },
            ],
          },
        ],
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['A-I', 'A-IIa', 'A-IIb', 'A-IIIa', 'B-IIa', 'B-IIc'],
              },
              {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Estado',
                t: 'sel',
                opts: ['A — AFECTO', 'I — INAFECTO', 'E — EXONERADO', 'B — BAJA POR VENCIMIENTO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Nuevo', 'Modificar', 'Excel', 'Imprimir', 'Guardar'],
  },
  vehicular_calculo: {
    ...
    tabla: {
      ...
      cols: ['Ejercicio', 'Base imponible S/', 'Tasa', 'Impuesto S/', 'Cuotas', 'Estado'],
      num: [1, 3],
    ...
    acciones: ['Simular', 'Calcular', 'Emitir cuponera'],
  },
  transferencia_vehiculo: {
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Tipo de acto',
            t: 'sel',
            opts: ['COMPRA-VENTA', 'DONACIÓN', 'REMATE', 'HERENCIA', 'DACIÓN EN PAGO'],
          },
          {
    ...
    acciones: ['Validar deuda', 'Registrar transferencia'],
  },
  espectaculos: {
    id: 'espectaculos',
    mod: 'Rentas · Registro',
    ...
    acciones: ['Liquidar', 'Registrar', 'Imprimir liquidación'],
  },
  beneficios: {
    id: 'beneficios',
    mod: 'Rentas · Registro',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Tipo',
        t: 'sel',
        opts: ['Todos', 'PENSIONISTA', 'ADULTO MAYOR', 'DISCAPACIDAD', 'INAFECTACIÓN', 'AMNISTÍA'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'VIGENTE', 'EN TRÁMITE', 'DENEGADO', 'VENCIDO'],
      },
    ],
    secciones: [
      {
    ...
    acciones: ['Registrar', 'Denegar', 'Aprobar'],
  },
  alta_deuda: {
    id: 'alta_deuda',
    mod: 'Rentas · Registro',
  ...
  baja_deuda: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Año',
        t: 'sel',
        opts: ['Todos', '2026', '2025', '2024', '2023', '2022', '2021', '2020'],
      },
      {
        clave: 'tributo',
        label: 'Tributo',
        t: 'sel',
        opts: ['Todos', 'IMPUESTO PREDIAL', 'ARBITRIOS', 'PATRIMONIO VEHICULAR', 'MULTAS'],
      },
    ],
    secciones: [
      {
    ...
    tabla: {
      ...
      cols: ['', 'Año', 'Unidad', 'Cuota', 'Tributo', 'Insoluto S/', 'Interés S/', 'Total S/'],
      num: [5, 6, 7],
    },
    acciones: ['Previsualizar', 'Dar de baja'],
  },
  fisc_programa: {
    id: 'fisc_programa',
    mod: 'Fiscalización',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'EN PREPARACIÓN', 'APROBADO', 'EN EJECUCIÓN', 'CERRADO'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['R. MENDOZA CRUZ', 'L. PEÑA SANDOVAL', 'A. VÍLCHEZ ROJAS'],
          },
          {
            clave: 'fechaDeInicio',
            label: 'Fecha de inicio',
          ...
          },
          {
            ...
            label: 'Estado',
            t: 'sel',
            opts: ['EN PREPARACIÓN', 'APROBADO', 'EN EJECUCIÓN', 'CERRADO'],
          },
        ],
      },
    ],
    tabla: {
      ...
      cols: ['Predio', 'Contribuyente', 'Uso declarado', 'Área decl. m²', 'Riesgo', 'Estado'],
      num: [3],
    },
    acciones: ['Generar muestra', 'Asignar fiscalizador', 'Aprobar programa'],
  },
  fisc_predial: {
    id: 'fisc_predial',
    mod: 'Fiscalización',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['PROPIETARIO', 'FAMILIAR', 'INQUILINO', 'ENCARGADO', 'NADIE ATENDIÓ'],
          },
          {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['01 — CONCRETO', '02 — LADRILLO', '03 — ADOBE', '04 — QUINCHA', '05 — MADERA'],
          },
          {
            clave: 'ecsVerificado',
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['AGUA, DESAGÜE Y LUZ', 'AGUA Y LUZ', 'SOLO LUZ', 'NINGUNO'],
          },
        ],
      },
      {
    ...
    acciones: ['Guardar borrador', 'Cerrar acta', 'Generar determinación'],
  },
  fisc_vehicular: {
    id: 'fisc_vehicular',
    mod: 'Fiscalización',
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['Todos', 'SUNARP', 'SUNAT', 'MTC', 'DECLARACIÓN'],
      },
      {
        clave: 'hallazgo',
        label: 'Hallazgo',
        t: 'sel',
        opts: ['Todos', 'NO DECLARADO', 'SUBVALUADO', 'BAJA INDEBIDA', 'CONFORME'],
      },
    ],
    tabla: {
    ...
    acciones: ['Importar cruce', 'Notificar requerimiento', 'Generar determinación'],
  },
  fisc_resultados: {
    id: 'fisc_resultados',
    mod: 'Fiscalización',
    ...
    filtros: [
      {
        ...
        label: 'Programa',
        t: 'sel',
        opts: ['PF-2026-014', 'PF-2026-011', 'PF-2025-032'],
      },
      {
        clave: 'hallazgo',
        label: 'Hallazgo',
        t: 'sel',
        opts: ['Todos', 'AMPLIACIÓN NO DECLARADA', 'OMISO', 'USO DISTINTO', 'SUBVALUACIÓN'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'PENDIENTE', 'DETERMINADO', 'NOTIFICADO', 'RECLAMADO'],
      },
    ],
    tabla: {
      title: 'Actas con diferencia determinada',
      cols: ['Acta', 'Predio', 'Hallazgo', 'Dif. m²', 'Ejercicios', 'Deuda omitida S/', 'Estado'],
      num: [3, 5],
    ...
    acciones: ['Exportar Excel', 'Emitir resoluciones de determinación'],
  },
  fisc_omisos: {
    id: 'fisc_omisos',
    mod: 'Fiscalización',
    ...
    acciones: ['Exportar', 'Programar fiscalización', 'Notificar esquela'],
  },
  fisc_estado_cuenta: {
    ...
    filtros: [
      {
        ...
        t: 'sel',
        opts: ['TRIBUTARIA', 'P. TRÁNSITO', 'P. ADMINISTRATIVA'],
      },
      {
        clave: 'papeleta',
        label: 'Papeleta',
        ...
        campos: [
          {
            ...
            label: 'Formato',
            t: 'sel',
            opts: ['CONSOLIDADO', 'DETALLADO', 'VOUCHER'],
          },
        ],
      },
    ],
    ...
    acciones: ['Buscar', 'Filtrar', 'Limpiar', 'Imprimir'],
  },
  fisc_historico: {
    id: 'fisc_historico',
    mod: 'Fiscalización',
          ...
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Estado',
                t: 'sel',
                opts: ['ABIERTA', 'EN PROCESO', 'LIQUIDADA', 'NOTIFICADA', 'ANULADA'],
              },
              {
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['CIERTA', 'PRESUNTA', 'DE OFICIO', 'GABINETE'],
              },
              {
                clave: 'ultimoUsuario',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['ART. 176 NUM. 1', 'ART. 177 NUM. 5', 'ART. 178 NUM. 1', 'ART. 173 NUM. 1'],
              },
              {
                clave: 'multaS',
                label: 'Multa (S/)',
    ...
    tabla: {
      ...
      cols: ['Est.', 'Cód. Cont.', 'Contribuyente', 'Nº Liquidación', 'Nº Notificación', 'Versión'],
      num: [5],
    },
    acciones: ['Buscar', 'Actualizar', 'Imprimir'],
  },
  ...
  papeletas: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todas', 'PENDIENTE', 'PAGADA', 'CON DESCARGO', 'FIRME', 'COACTIVA', 'ANULADA'],
      },
    ],
    tabs: [
      {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['A. VÍLCHEZ ROJAS', 'L. PEÑA SANDOVAL', 'J. RUIZ PALACIOS'],
              },
              {
                clave: 'nDeCredencial',
              ...
              },
              {
                ...
                label: 'Supervisor',
                t: 'sel',
                opts: ['C. ANCAJIMA FLORES', 'R. MENDOZA CRUZ'],
              },
            ],
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['AUTOMÓVIL', 'CAMIONETA', 'MOTOCICLETA', 'ÓMNIBUS', 'CAMIÓN', 'MOTOTAXI'],
              },
              {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['NO APLICA', 'DEPÓSITO SULLANA NORTE', 'DEPÓSITO BELLAVISTA'],
              },
              {
    ...
    acciones: ['Nuevo', 'Notificar', 'Imprimir', 'Guardar'],
  },
  transito_busqueda: {
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['(TODOS)', 'PENDIENTE', 'A CUENTA', 'CANCELADA', 'FRACCIONADA', 'ANULADA'],
      },
      {
        clave: 'ingresadoPor',
        label: 'Ingresado por',
    ...
    acciones: ['Buscar', 'Limpiar', 'Ver propietario y pagos', 'Excel'],
  },
  codigos_transito: {
    id: 'codigos_transito',
    mod: 'Tránsito',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Gravedad',
        t: 'sel',
        opts: ['Todas', 'MUY GRAVE', 'GRAVE', 'LEVE'],
      },
      {
  ...
  transito_descargos: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'EN EVALUACIÓN', 'FUNDADO', 'INFUNDADO', 'IMPROCEDENTE'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['DESCARGO', 'RECONSIDERACIÓN', 'APELACIÓN', 'NULIDAD'],
          },
          {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['FUNDADO', 'INFUNDADO', 'IMPROCEDENTE', 'FUNDADO EN PARTE'],
          },
          {
            clave: 'efectoSobreLaMulta',
            label: 'Efecto sobre la multa',
            t: 'sel',
            opts: ['SE MANTIENE', 'SE DEJA SIN EFECTO', 'SE REDUCE'],
          },
          {
    ...
    acciones: ['Registrar descargo', 'Resolver', 'Notificar al administrado'],
  },
  internamiento: {
    id: 'internamiento',
    mod: 'Tránsito',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Depósito',
        t: 'sel',
        opts: ['Todos', 'DEPÓSITO SULLANA NORTE', 'DEPÓSITO BELLAVISTA'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'INTERNADO', 'LIBERADO', 'EN ABANDONO'],
      },
    ],
    secciones: [
      {
    ...
    acciones: ['Registrar ingreso', 'Liberar vehículo'],
  },
  transito_documentos: {
        ...
        campos: [
          {
            ...
            label: 'Documento',
            t: 'sel',
            opts: ['RESOLUCIÓN', 'NOTIFICACIÓN', 'INFORME', 'CARTA', 'MEMORANDO'],
          },
          {
            clave: 'nDoc',
            label: 'Nº Doc.',
    ...
    tabla: {
      ...
      cols: ['Placa', 'Papeleta', 'Expediente', 'Código', 'Obligado'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Deshacer', 'Imprimir'],
  },
  transito_valores: {
    id: 'transito_valores',
    mod: 'Tránsito',
    ...
    tabla: {
      ...
      cols: ['Cod. Criterio', 'Descripción', 'Tipo Rec.', 'Fec. Ini.', 'Fec. Fin.', 'Est.'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Procesar', 'Anular', 'Imprimir'],
  },
  transito_cambio_numero: {
    ...
    acciones: ['Consultar', 'Modificar', 'Salir'],
  },
  transito_reportes: {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Acción',
            t: 'sel',
            opts: ['GENERAR', 'REIMPRIMIR', 'ANULAR'],
          },
          {
            clave: 'nConstancia',
            label: 'Nº constancia',
          ...
          },
          {
            ...
            label: 'Ordenación',
            t: 'sel',
            opts: ['FECHA DE INFRACCIÓN', 'Nº DE PAPELETA', 'PLACA', 'CONDUCTOR', 'IMPORTE'],
          },
          {
            clave: 'agrupadoPor',
            label: 'Agrupado por',
            t: 'sel',
            opts: ['MES', 'AÑO', 'CÓDIGO DE INFRACCIÓN', 'ESTADO', 'PLACA'],
          },
        ],
      },
    ],
    acciones: ['Exportar', 'Imprimir', 'Pantalla', 'Cancelar'],
  },
  transito_record_conductor: {
    ...
    reporte: {
      ...
      cols: ['Papeleta', 'Fecha', 'Placa', 'Infracción', 'Importe S/', 'Estado'],
      num: [4],
    },
  },
  transito_record_vehicular: {
    ...
    reporte: {
      ...
      cols: ['Papeleta', 'Fecha', 'Conductor', 'Infracción', 'Importe S/', 'Estado'],
      num: [4],
    },
  },
  transito_constancia_libre: {
    ...
    reporte: {
      ...
      cols: ['Concepto', 'Periodo verificado', 'Papeletas', 'Situación'],
      num: [2],
    },
  },
  transito_padron: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Ordenado por',
        t: 'sel',
        opts: ['FECHA', 'Nº PAPELETA', 'PLACA', 'IMPORTE'],
      },
    ],
    tabla: {
  ...
  transito_estado_cuenta: {
    ...
    acciones: ['Imprimir', 'Voucher de pago'],
  },
  transito_papeleta_reporte: {
    ...
    reporte: {
      ...
      cols: ['Concepto', 'Detalle', 'Importe S/'],
      num: [2],
    },
  },
  transito_rg_ordinaria: {
    ...
    reporte: {
      ...
      cols: ['Concepto', 'Periodo', 'Importe S/'],
      num: [2],
    },
  },
  ...
  transito_padron_coactiva: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Ejecutor',
        t: 'sel',
        opts: ['Todos', 'CHECA FERNÁNDEZ-HILTON ARTURO', 'GARCÍA NAVARRO-MARTHA ELENA'],
      },
      {
        clave: 'estadoDelExpediente',
        label: 'Estado del expediente',
        t: 'sel',
        opts: ['Todos', 'REC 01 EMITIDO', 'NOTIFICADO', 'MEDIDA CAUTELAR', 'CONCLUIDO'],
      },
    ],
    tabla: {
      title: 'Papeletas en coactiva',
      cols: ['Expediente', 'Papeleta', 'Fec. pase', 'Placa', 'Obligado', 'Deuda S/', 'Estado'],
      num: [5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  transito_padron_constancias: {
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['Todos', 'VRETO', 'MRIOS', 'SISTEMAS'],
      },
    ],
    tabla: {
      title: 'Constancias emitidas',
      cols: ['Nº constancia', 'Fecha', 'Placa', 'Solicitante', 'Recibo', 'Importe S/', 'Usuario'],
      num: [5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  transito_resumen_recaudacion: {
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['Todas', 'ORDINARIA', 'COACTIVA', 'CONVENIO'],
      },
      {
        clave: 'agrupadoPor',
        label: 'Agrupado por',
        t: 'sel',
        opts: ['MES', 'AÑO', 'TIPO DE COBRANZA'],
      },
      {
        clave: 'caja',
        label: 'Caja',
        t: 'sel',
        opts: ['Todas', 'CAJA 01', 'CAJA 02', 'CAJA 03'],
      },
    ],
    tabla: {
      title: 'Recaudación por mes',
      cols: ['Mes', 'Ordinaria S/', 'Coactiva S/', 'Convenios S/', 'Papeletas pagadas', 'Total S/'],
      num: [1, 2, 3, 4, 5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  transito_resumen_papeletas: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Agrupado por',
        t: 'sel',
        opts: ['AÑO', 'MES', 'ESTADO', 'CÓDIGO DE INFRACCIÓN'],
      },
      {
        clave: 'cobranza',
        label: 'Cobranza',
        t: 'sel',
        opts: ['Todas', 'ORDINARIA', 'COACTIVA'],
      },
    ],
    tabla: {
  ...
  transito_resumen_codigo: {
    ...
    tabla: {
      ...
      cols: ['Código', 'Descripción', 'Pendientes', 'Pendiente S/', 'Pagadas', 'Pagado S/'],
      num: [2, 3, 4, 5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  transito_resumen_placa: {
    ...
    tabla: {
      ...
      cols: ['Iniciales', 'Papeletas', 'Pendientes', 'Pendiente S/', 'Pagadas', 'Pagado S/'],
      num: [1, 2, 3, 4, 5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  adm_notificacion: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['(TODOS)', 'NOTIFICADA', 'VENCIDA', 'SUBSANADA', 'CON PAPELETA', 'ANULADA'],
      },
    ],
    secciones: [
      {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Fiscalizador',
            t: 'sel',
            opts: ['RETO SANTOS, VÍCTOR', 'RÍOS MENDOZA, MARÍA', 'QUISPE PEÑA, JORGE'],
          },
          {
            clave: 'recibidoPor',
            label: 'Recibido por',
            t: 'sel',
            opts: ['CONTRIBUYENTE', 'FAMILIAR', 'DEPENDIENTE', 'NEGATIVA A RECIBIR', 'CEDULÓN'],
          },
          {
    ...
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Anular', 'Imprimir'],
  },
  infracciones_adm: {
    id: 'infracciones_adm',
    mod: 'Infracciones',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Código CUIS',
        t: 'sel',
        opts: ['Todos', 'C-101', 'C-214', 'S-018', 'A-042'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'PREVENTIVA', 'CONSTATADA', 'SANCIONADA', 'PAGADA', 'COACTIVA'],
      },
    ],
    tabs: [
      {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Inspector',
                t: 'sel',
                opts: ['L. PEÑA SANDOVAL', 'A. VÍLCHEZ ROJAS'],
              },
              {
                clave: 'supervisor',
                label: 'Supervisor',
    ...
    acciones: ['Nuevo', 'Emitir RIS', 'Imprimir', 'Guardar'],
  },
  codigos_cuis: {
    id: 'codigos_cuis',
    mod: 'Infracciones',
    ...
    tabla: {
      ...
      cols: ['Código', 'Materia', 'Descripción', '% UIT', 'Multa S/', 'Medida complementaria'],
      num: [3, 4],
    },
    acciones: ['Nuevo', 'Guardar'],
  },
  adm_codigos_reporte: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['VIGENTES', 'DEROGADOS', 'TODOS'],
      },
      {
        clave: 'ordenadoPor',
        label: 'Ordenado por',
        t: 'sel',
        opts: ['CÓDIGO', 'DESCRIPCIÓN', 'IMPORTE'],
      },
    ],
    tabla: {
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Tipo de recaudo',
            t: 'sel',
            opts: ['035 — RM PAPELETAS ADMINISTRATIVAS', '003 — RS PAPELETAS DE TRÁNSITO'],
          },
          {
            clave: 'vencimiento',
            label: 'Vencimiento',
  ...
  adm_resolucion_gerencia: {
    ...
    reporte: {
      ...
      cols: ['Concepto', 'Base legal', 'Importe S/'],
      num: [2],
    },
  },
  adm_notificacion_resolucion: {
    ...
    reporte: {
      ...
      cols: ['Dato del acto de notificación', 'Detalle'],
      num: [],
    },
  },
  adm_reportes: {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Fiscalizador',
            t: 'sel',
            opts: ['(TODOS)', 'RETO SANTOS, VÍCTOR', 'RÍOS MENDOZA, MARÍA', 'QUISPE PEÑA, JORGE'],
            ancho: true,
          },
          {
            clave: 'direccionDelPredio',
  ...
  adm_padron_notificaciones: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Agrupado por',
        t: 'sel',
        opts: ['MES', 'FISCALIZADOR', 'INFRACCIÓN', 'CIIU'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['(TODOS)', 'NOTIFICADA', 'VENCIDA', 'SUBSANADA', 'CON PAPELETA'],
      },
    ],
    tabla: {
  ...
  adm_notificaciones_vencidas: {
    ...
    acciones: ['Generar papeleta', 'Imprimir', 'Excel'],
  },
  adm_notificaciones_contribuyente: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Agrupado por',
        t: 'sel',
        opts: ['AÑO Y MES', 'INFRACCIÓN', 'ESTADO'],
      },
    ],
    tabla: {
      title: 'Papeletas del contribuyente',
      cols: ['Año', 'Mes', 'Papeleta', 'Infracción', 'Multa S/', 'Recibo', 'Fec. pago', 'Estado'],
      num: [4],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  adm_resumen_recaudacion: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Agrupado por',
        t: 'sel',
        opts: ['MES', 'INFRACCIÓN', 'TIPO DE COBRANZA'],
      },
      {
        clave: 'tipoDeCobranza',
        label: 'Tipo de cobranza',
    ...
    tabla: {
      title: 'Recaudación por mes',
      cols: ['Mes', 'Papeletas pagadas', 'Ordinaria S/', 'Coactiva S/', 'Convenios S/', 'Total S/'],
      num: [1, 2, 3, 4, 5],
    },
    acciones: ['Imprimir', 'Excel'],
  },
  caja_tributaria: {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Fase',
            t: 'sel',
            opts: ['TODAS', 'ORDINARIA', 'VALOR EMITIDO', 'COACTIVA'],
          },
          {
            clave: 'concepto',
            label: 'Concepto',
    ...
    tabla: {
      ...
      acciones: ['Marcar todos', 'Quitar selección'],
    },
    totales: [
      {
        label: 'Deuda total',
    ...
    acciones: ['Limpiar', 'Cargar deudas', 'Cobrar deuda'],
  },
  caja_tasas: {
    id: 'caja_tasas',
    mod: 'Tesorería',
    ...
    tabla: {
      ...
      cols: ['', 'Partida', 'Concepto TUPA', 'Área', 'Cantidad', 'Precio S/', 'Importe S/'],
      num: [4, 5, 6],
    },
    totales: [
      {
    ...
    acciones: ['Limpiar', 'Cobrar y emitir recibo'],
  },
  fraccionamiento: {
    id: 'fraccionamiento',
    mod: 'Tesorería',
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Estado',
            t: 'sel',
            opts: ['VIGENTE', 'CUMPLIDO', 'EN RIESGO', 'QUEBRADO'],
          },
        ],
      },
      {
        ...
        campos: [
          {
            ...
            t: 'sel',
            opts: ['NO REQUIERE', 'CARTA FIANZA', 'HIPOTECA', 'AVAL', 'PRENDA'],
          },
          {
    ...
    tabla: {
      ...
      cols: ['Nro', 'Cuota', 'Capital', 'Interes', 'Gasto.Conv.', 'Gasto.Cuota', 'Vencimiento'],
      num: [1, 2, 3, 4, 5],
    ...
    acciones: ['Fraccionar', 'Imprimir simulación', 'Aceptar'],
  },
  consulta_convenios: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'VIGENTE', 'CUMPLIDO', 'EN RIESGO', 'QUEBRADO'],
      },
      {
        clave: 'desde',
        label: 'Desde',
    ...
    acciones: ['Exportar', 'Imprimir cronograma'],
  },
  duplicado_recibo: {
    id: 'duplicado_recibo',
    mod: 'Tesorería',
    ...
    acciones: ['Vista previa', 'Imprimir duplicado'],
  },
  anulacion_recibo: {
    id: 'anulacion_recibo',
    mod: 'Tesorería',
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Autorizado por',
            t: 'sel',
            opts: ['RESPONSABLE DE TESORERÍA', 'GERENTE DE ADMINISTRACIÓN TRIBUTARIA'],
          },
          {
            clave: 'nDeMemorando',
    ...
    acciones: ['Verificar recibo', 'Anular recibo'],
  },
  anulacion_convenio: {
    ...
    filtros: [
      ...
      },
      {
        ...
        t: 'sel',
        opts: ['Todos', 'NORMAL', 'ANULADO', 'QUEBRADO', 'REFORMADO', 'CANCELADO'],
      },
      {
    ...
    tabla: {
      ...
      cols: ['Num. Anul.', 'Num. Conv.', 'Fecha Anul.', 'Contribuyente', 'Motivo', 'Responsable'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Deshacer', 'Anular', 'Reformar', 'Quebrar'],
  },
  cierre_caja: {
    id: 'cierre_caja',
    mod: 'Tesorería',
    ...
    acciones: ['Cuadrar', 'Imprimir arqueo', 'Cerrar caja'],
  },
  avance_recaudacion: {
    ...
    acciones: ['Excel', 'Imprimir avance'],
  },
  recaudacion_area: {
    id: 'recaudacion_area',
    mod: 'Tesorería',
    ...
    tabla: {
      ...
      cols: ['Partida', 'Descripción', 'Monto S/'],
      num: [2],
      note: 'Total del periodo para el área seleccionada: S/ 35,579.33',
    },
    acciones: ['Excel', 'Imprimir por partida', 'Imprimir por tributo'],
  },
  cuenta_corriente: {
    id: 'cuenta_corriente',
    mod: 'Consultas',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Situación',
        t: 'sel',
        opts: ['Todas', 'CON DEUDA', 'CANCELADO'],
      },
    ],
    tabla: {
      title: 'Cuenta corriente — CASTILLO PASCUALA, MARÍA ELENA',
      cols: ['Año', 'Tributo', 'Unidad', 'Cuota', 'Emitido S/', 'Pagado S/', 'Saldo S/', 'Fase'],
      num: [4, 5, 6],
    },
    totales: [
      {
    ...
    acciones: ['Excel', 'Imprimir estado de cuenta'],
  },
  consulta_deuda: {
    id: 'consulta_deuda',
    mod: 'Consultas',
    ...
    acciones: ['Excel', 'Imprimir liquidación de deuda'],
  },
  consulta_unificada: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Impresión',
        t: 'sel',
        opts: ['PREDIAL', 'ARBITRIOS', 'PREDIAL Y ARBITRIOS'],
      },
    ],
    tabs: [
      {
            ...
            campos: [
              {
                ...
                label: 'Alta / Baja',
                t: 'sel',
                opts: ['(TODAS)', 'A — ALTA', 'B — BAJA'],
              },
              {
                clave: 'autoManual',
                label: 'Auto / Manual',
                t: 'sel',
                opts: ['(TODAS)', 'A — AUTOMÁTICA', 'M — MANUAL'],
              },
              {
                clave: 'nDocum',
                label: 'Nº Docum.',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['(TODOS)', 'ALTA', 'TRANSFERENCIA', 'MODIFICACIÓN', 'BAJA'],
              },
              {
                clave: 'desde2',
                label: 'Desde',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Estado',
                t: 'sel',
                opts: ['Todos', 'NORMAL', 'CANCELADO', 'ANULADO', 'QUEBRADO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Buscar', 'Imprimir', 'Impuestos calculados por predio'],
  },
  consulta_resumen_predial: {
    ...
    acciones: ['Buscar', 'Limpiar', 'Detalle de deudas', 'Actualizar deuda'],
  },
  consulta_altas_bajas: {
    ...
    acciones: ['Buscar', 'Imprimir', 'Excel'],
  },
  consulta_deudas_beneficio: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Forma de pago',
        t: 'sel',
        opts: ['PRECONVENIO', 'CONTADO TOTAL'],
      },
      {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Impresión',
            t: 'sel',
            opts: ['CONSOLIDADO', 'DETALLADO', 'BENEFICIO'],
          },
          {
    ...
    acciones: ['Filtrar', 'Limpiar', 'Imprimir', 'Bajar deuda'],
  },
  consulta_pagos: {
    id: 'consulta_pagos',
    mod: 'Consultas',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Medio de pago',
        t: 'sel',
        opts: ['Todos', 'EFECTIVO', 'TARJETA', 'DEPÓSITO', 'PAGO EN LÍNEA'],
      },
    ],
    tabla: {
      title: 'Pagos registrados',
      cols: ['Fecha', 'Recibo', 'Concepto', 'Año', 'Medio', 'Caja', 'Importe S/'],
      num: [6],
    },
  ...
  consulta_vehiculos: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'AFECTO', 'INAFECTO', 'EXONERADO', 'BAJA'],
      },
    ],
    tabla: {
      title: 'Vehículos encontrados',
  ...
  consulta_valores: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Tipo',
        t: 'sel',
        opts: ['Todos', 'ORDEN DE PAGO', 'RES. DETERMINACIÓN', 'RES. DE MULTA'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'EMITIDO', 'NOTIFICADO', 'FIRME', 'RECLAMADO', 'COACTIVA', 'ANULADO'],
      },
    ],
    tabla: {
  ...
  constancia: {
    ...
    reporte: {
      ...
      cols: ['Tributo', 'Ejercicios', 'Situación', 'Saldo S/'],
      num: [3],
    },
  },
  valores_individual: {
        ...
        campos: [
          {
            ...
            label: 'Tipo de valor',
            t: 'sel',
            opts: ['ORDEN DE PAGO', 'RESOLUCIÓN DE DETERMINACIÓN', 'RESOLUCIÓN DE MULTA'],
          },
          {
            clave: 'nroDeValor',
            label: 'Nro. de valor',
          ...
          },
          {
            ...
            label: 'Tributo',
            t: 'sel',
            opts: ['IMPUESTO PREDIAL', 'ARBITRIOS', 'PATRIMONIO VEHICULAR', 'ALCABALA', 'MULTA'],
          },
          {
            clave: 'unidadPredioPlaca',
            label: 'Unidad (predio / placa)',
  ...
  valores_masivo: {
        ...
        campos: [
          {
            ...
            label: 'Tipo de valor',
            t: 'sel',
            opts: ['ORDEN DE PAGO', 'RESOLUCIÓN DE DETERMINACIÓN'],
          },
          {
          ...
          },
          {
            ...
            label: 'Tributo',
            t: 'sel',
            opts: ['TODOS', 'IMPUESTO PREDIAL', 'ARBITRIOS', 'PATRIMONIO VEHICULAR'],
          },
          {
            clave: 'sector',
            label: 'Sector',
    ...
    acciones: ['Simular', 'Ver excluidos', 'Generar valores'],
  },
  valores_busqueda: {
    id: 'valores_busqueda',
    mod: 'Valores y coactiva',
    ...
    acciones: ['Excel', 'Anular valor', 'Derivar a coactiva'],
  },
  notificacion_valores: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Notificador',
        t: 'sel',
        opts: ['Todos', 'J. RUIZ PALACIOS', 'A. VÍLCHEZ ROJAS'],
      },
      {
        clave: 'resultado',
        label: 'Resultado',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            t: 'sel',
            opts: ['PERSONAL EN DOMICILIO FISCAL', 'CEDULÓN', 'PUBLICACIÓN', 'BUZÓN ELECTRÓNICO'],
          },
          {
            clave: 'fechaDeNotificacion',
            label: 'Fecha de notificación',
          ...
          },
          {
            ...
            label: 'Notificador',
            t: 'sel',
            opts: ['J. RUIZ PALACIOS', 'A. VÍLCHEZ ROJAS'],
          },
          {
            clave: 'resultado2',
            label: 'Resultado',
          ...
          },
          {
            ...
            label: 'Vínculo',
            t: 'sel',
            opts: ['TITULAR', 'FAMILIAR', 'EMPLEADO', 'PORTERO', 'OTRO'],
          },
          {
    ...
    acciones: ['Imprimir cargo', 'Registrar notificación'],
  },
  prescripcion: {
    id: 'prescripcion',
    mod: 'Valores y coactiva',
    ...
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Tributo',
            t: 'sel',
            opts: ['IMPUESTO PREDIAL', 'ARBITRIOS', 'PATRIMONIO VEHICULAR', 'MULTA'],
          },
          {
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Resultado',
            t: 'sel',
            opts: ['PROCEDE', 'PROCEDE EN PARTE', 'NO PROCEDE'],
          },
          {
            clave: 'nDeResolucion',
            label: 'Nº de resolución',
    ...
    acciones: ['Calcular', 'Notificar', 'Resolver'],
  },
  pase_coactiva: {
    id: 'pase_coactiva',
    mod: 'Coactiva',
    ...
    acciones: ['Nuevo', 'Modificar', 'Generar', 'Inactivar', 'Imprimir'],
  },
  coactiva_expedientes: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Ejecutor',
        t: 'sel',
        opts: ['R. MENDOZA CRUZ', 'C. ANCAJIMA FLORES'],
      },
      {
        clave: 'estado',
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'INICIADO', 'CON MEDIDA CAUTELAR', 'SUSPENDIDO', 'CONCLUIDO'],
      },
    ],
    tabs: [
      {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['S. PALACIOS NIMA', 'K. CHERO VARGAS'],
              },
              {
                clave: 'codContribuyente2',
                label: 'Cod. Contribuyente',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Resultado',
                t: 'sel',
                opts: ['EN TRÁMITE', 'RETENIDO', 'SIN FONDOS', 'LEVANTADA'],
              },
            ],
          },
        ],
    ...
    acciones: ['Iniciar cobranza', 'Trabar medida', 'Suspender', 'Imprimir REC'],
  },
  importacion_valores: {
    ...
    filtros: [
      {
        ...
        label: 'Tipo de deuda',
        t: 'sel',
        opts: ['TRIBUTARIA', 'P. TRÁNSITO', 'P. ADMINISTRATIVA', 'CLAUSURA DE LOCAL'],
      },
      {
        clave: 'contribuyente',
        label: 'Contribuyente',
            ...
            campos: [
              {
                ...
                label: 'Auxiliar',
                t: 'sel',
                opts: ['GARCÍA NAVARRO-MARTHA ELENA', 'RÍOS MENDOZA-MARÍA', 'NO ESPECIFICADO'],
              },
              {
                clave: 'ejecutor',
                label: 'Ejecutor',
                t: 'sel',
                opts: ['CHECA FERNÁNDEZ-HILTON ARTURO', 'QUISPE PEÑA-JORGE', 'NO ESPECIFICADO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Importar valores', 'Expedientes libres', 'Rechazar recaudo', 'Limpiar campos'],
  },
  proceso_coactivo: {
    id: 'proceso_coactivo',
    mod: 'Coactiva',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'REC 01 EMITIDO', 'REC 02 EMITIDA', 'MEDIDA CAUTELAR', 'CONCLUIDO'],
      },
    ],
    tabs: [
      {
            ...
            campos: [
              {
                ...
                label: 'Auxiliar',
                t: 'sel',
                opts: ['NO ESPECIFICADO', 'GARCÍA NAVARRO-MARTHA ELENA', 'RÍOS MENDOZA-MARÍA'],
              },
              {
                clave: 'ejecutor',
                label: 'Ejecutor',
                t: 'sel',
                opts: ['NO ESPECIFICADO', 'CHECA FERNÁNDEZ-HILTON ARTURO', 'QUISPE PEÑA-JORGE'],
              },
            ],
          },
          {
    ...
    tabla: {
      ...
      cols: ['ExpCoact', 'Codigo', 'Nombre', 'Asunto', 'Estado', 'CodTipoRecaudo', 'ExpedAnt'],
      num: [],
    },
    acciones: ['Buscar', 'Actualizar deuda', 'Imprimir'],
  },
  rec_impresion: {
    id: 'rec_impresion',
    mod: 'Coactiva',
    ...
    tabla: {
      ...
      cols: ['Seleccione', 'Numero', 'Año', 'CodContribuyente', 'Nombre', 'Estado', 'Asunto'],
      num: [],
    },
    acciones: [
      'Listar expedientes',
  ...
  expediente_historial: {
    ...
    tabla: {
      ...
      cols: ['Numero', 'Año', 'Cod. Contribuyente', 'Contribuyente', 'Exped. Ant.'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Quitar', 'Guardar cambios', 'Limpiar'],
  },
  cambiar_direccion_ref: {
    ...
    acciones: ['Buscar', 'Limpiar', 'Cambiar'],
  },
  costas_procesales: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'A — ACTIVA', 'N — NOTIFICADA', 'C — CANCELADA', 'X — ANULADA'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          {
            ...
            label: 'Tributo',
            t: 'sel',
            opts: ['00101 — COSTAS PROCESALES', '00102 — GASTOS DE EJECUCIÓN'],
          },
          {
            clave: 'descripcion',
            label: 'Descripción',
  ...
  fraccionamiento_coactivo: {
    ...
    filtros: [
      {
        ...
        label: 'Forma de pago',
        t: 'sel',
        opts: ['CONVENIO TRIBUTARIO PERMA', 'CONVENIO COACTIVO ORDENANZA', 'PRECONVENIO'],
      },
      {
        clave: 'benefAplicable',
        label: 'Benef. aplicable',
        t: 'sel',
        opts: ['CONVENIO PERMANENTE', 'AMNISTÍA COACTIVA 2026', 'SIN BENEFICIO'],
      },
      {
        clave: 'contribuyente',
        label: 'Contribuyente',
    ...
    acciones: ['Filtrar', 'Limpiar', 'Fraccionamiento'],
  },
  actos_coactivos: {
    id: 'actos_coactivos',
    mod: 'Coactiva',
    ...
    tabla: {
      ...
      cols: ['Expediente', 'Codigo', 'Obligado', 'Deuda S/', 'Referencia', 'Tributo'],
      num: [3],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Imprimir', 'Padrón'],
  },
  notificaciones_coactivas: {
    ...
    acciones: ['Nuevo', 'Modificar', 'Grabar', 'Deshacer', 'Vista', 'Resol. consentida'],
  },
  ...
  coactiva_deudas_beneficio: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Benef. aplicable',
        t: 'sel',
        opts: ['AMNISTÍA COACTIVA 2026', 'CONTADO COACTIVO PERM', 'FRACCIONAMIENTO COACTIVO'],
      },
      {
        clave: 'fechaDeCalculo',
        label: 'Fecha de cálculo',
    ...
    acciones: ['Filtrar', 'Imprimir', 'Generar convenio coactivo'],
  },
  anuncios: {
    id: 'anuncios',
    mod: 'Autorizaciones',
          ...
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Tipo Anuncio',
                t: 'sel',
                opts: ['AVISO SIMPLE', 'AVISO LUMINOSO', 'AVISO ILUMINADO', 'AVISO ELECTRÓNICO'],
              },
              {
                clave: 'forma',
                label: 'Forma',
                t: 'sel',
                opts: ['MONOLITO', 'ADOSADO', 'BIPOSTE', 'MONOPOSTE', 'TIPO BANDERA'],
              },
              {
                clave: 'denominacion',
                label: 'Denominación',
    ...
    acciones: ['Nuevo', 'Activar', 'Excel', 'Imprimir', 'Guardar'],
  },
  anuncios_reportes: {
        ...
        campos: [
          {
            ...
            label: 'Reporte',
            t: 'sel',
            opts: ['PADRÓN DE ANUNCIOS Y PROPAGANDAS'],
            ancho: true,
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Estado',
            t: 'sel',
            opts: ['ACTIVA', 'VENCIDA', 'ANULADA', 'TODAS'],
          },
          {
            clave: 'contribuyente',
            label: 'Contribuyente',
  ...
  licencia_funcionamiento: {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['DEFINITIVA', 'TEMPORAL', 'CESIONARIA'],
              },
              {
                clave: 'fechaDeEmision',
                label: 'Fecha de emisión',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['COMPATIBLE', 'COMPATIBLE CON RESTRICCIONES', 'NO COMPATIBLE'],
              },
              {
                clave: 'aforoAutorizado',
                label: 'Aforo autorizado',
              ...
              },
              {
                ...
                t: 'sel',
                opts: ['PROPIO', 'ALQUILADO', 'CEDIDO EN USO'],
              },
            ],
          },
          {
            ...
            campos: [
              {
                ...
                t: 'sel',
                opts: ['RIESGO BAJO', 'RIESGO MEDIO', 'RIESGO ALTO', 'RIESGO MUY ALTO'],
              },
              {
                clave: 'momentoDeLaItse',
                label: 'Momento de la ITSE',
                t: 'sel',
                opts: ['PREVIA', 'POSTERIOR'],
              },
              {
              ...
              },
              {
                ...
                label: 'Resultado',
                t: 'sel',
                opts: ['PENDIENTE', 'CONFORME', 'OBSERVADO', 'NO CONFORME'],
              },
            ],
          },
        ],
            ...
            campos: [
              {
                ...
                t: 'sel',
                opts: ['COMERCIO', 'SERVICIOS', 'INDUSTRIA'],
              },
              {
                clave: 'zona',
                label: 'Zona',
                t: 'sel',
                opts: ['Zona 1', 'Zona 2', 'Zona 3'],
              },
              {
    ...
    acciones: ['Nuevo', 'Activar', 'Duplicar', 'Imprimir licencia', 'Guardar'],
  },
  licencia_padron: {
    id: 'licencia_padron',
    mod: 'Autorizaciones y licencias',
      ...
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Criterio',
            t: 'sel',
            opts: ['GIRO COMERCIAL', 'DIRECCIÓN', 'NOMBRE CONTRIBUYENTE'],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Criterio',
            t: 'sel',
            opts: ['NÚMERO DE LICENCIA', 'NOMBRE CONTRIBUYENTE', 'GIRO COMERCIAL', 'DIRECCIÓN'],
          },
        ],
      },
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Estado',
            t: 'sel',
            opts: ['ACTIVA', 'CANCELADA', 'DUPLICADA', 'VENCIDA', 'TODAS'],
          },
          {
            clave: 'tipoLic',
            label: 'Tipo Lic.',
            t: 'sel',
            opts: ['(TODOS)', 'INDETERMINADA', 'TEMPORAL', 'CESIONARIO', 'MERCADO'],
          },
          {
            clave: 'ciiu',
            label: 'CIIU',
  ...
  licencia_resumen_anual: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Agrupado por',
        t: 'sel',
        opts: ['AÑO', 'GIRO COMERCIAL', 'TIPO DE LICENCIA'],
      },
    ],
    tabla: {
  ...
  fue_edificacion: {
          ...
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Revisión',
                t: 'sel',
                opts: ['REVISORES URBANOS', 'COMISION TECNICA'],
              },
              {
          ...
          },
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'SOLICITANTE',
                t: 'sel',
                opts: ['PROPIETARIO', 'NO PROPIETARIO'],
              },
            ],
          },
        ],
    ...
    acciones: ['Nuevo', 'Inactivar', 'Excel', 'Imprimir', 'Guardar'],
  },
  edificacion_reporte: {
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'EN TRÁMITE', 'APROBADA', 'OBSERVADA', 'DENEGADA', 'CONFORME DE OBRA'],
      },
    ],
    tabla: {
  ...
  certificados: {
        ...
        campos: [
          {
            ...
            t: 'sel',
            opts: ['NUMERACIÓN', 'ZONIFICACIÓN Y VÍAS', 'PARÁMETROS URBANÍSTICOS', 'JURISDICCIÓN'],
          },
          {
            clave: 'codigoPredial',
            label: 'Código predial',
    ...
    tabla: {
      ...
      cols: ['Nº certificado', 'Tipo', 'Predio', 'Solicitante', 'Fecha', 'Derecho S/', 'Estado'],
      num: [5],
    },
    acciones: ['Emitir', 'Imprimir certificado'],
  },
  modulos: {
    id: 'modulos',
    mod: 'Seguridad',
    ...
    tabla: {
      ...
      cols: ['Codigo', 'Abreviatura', 'Nombre del módulo', 'Estado'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Deshacer', 'Limpiar', 'Imprimir'],
  },
  usuarios: {
    id: 'usuarios',
    mod: 'Seguridad',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Estado',
        t: 'sel',
        opts: ['Todos', 'ACTIVA', 'BLOQUEADA', 'INACTIVA'],
      },
    ],
    secciones: [
      {
        ...
        campos: [
          ...
          },
          {
            ...
            label: 'Estado',
            t: 'sel',
            opts: ['ACTIVA', 'BLOQUEADA', 'INACTIVA'],
          },
          {
    ...
    acciones: ['Nuevo', 'Restablecer contraseña', 'Eliminar', 'Guardar'],
  },
  grupos: {
    id: 'grupos',
    mod: 'Seguridad',
  ...
  accesos: {
    ...
    filtros: [
      {
        ...
        label: 'Tipo',
        t: 'sel',
        opts: ['(TODOS)', 'OPCIÓN MENÚ', 'POLÍTICA'],
      },
      {
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Modulo',
                t: 'sel',
                opts: ['SIGTM', 'SIGAM', 'SISEG'],
              },
              {
                clave: 'tipo2',
                label: 'Tipo',
                t: 'sel',
                opts: ['OPCIÓN MENÚ', 'POLÍTICA'],
              },
              {
                clave: 'objetoControl',
        ...
        secciones: [
          {
            ...
            campos: [
              ...
              },
              {
                ...
                label: 'Grupo',
                t: 'sel',
                opts: ['ADMINISTRADORES', 'CAJA', 'EJECUCIÓN PO', 'PLANEAMIENTO', 'FISCALIZACIÓN'],
              },
              {
                clave: 'usuario',
                label: 'Usuario',
    ...
    tabla: {
      ...
      cols: ['Código', 'Tipo', 'Nombre del acceso', 'Modulo', 'Nivel', 'Estado'],
      num: [],
    },
    acciones: ['Nuevo', 'Modificar', 'Guardar', 'Deshacer', 'Eliminar', 'Imprimir'],
  },
  miembros: {
    id: 'miembros',
    mod: 'Seguridad',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Grupo',
        t: 'sel',
        opts: ['ADMINISTRADORES', 'CAJA', 'EJECUCIÓN PO', 'PLAN', 'PLANEAMIENTO', 'FISCALIZACIÓN'],
      },
      {
        clave: 'modulo',
        label: 'Modulo',
    ...
    tabla: {
      ...
      cols: ['Usuario', 'Grupo', 'Fec. Alta', 'Fec. Baja', 'Estado'],
      num: [],
    },
    acciones: ['Nuevo', 'Agregar', 'Guardar', 'Eliminar', 'Imprimir'],
  },
  permisos: {
    id: 'permisos',
    mod: 'Seguridad',
    ...
    tabla: {
      ...
      acciones: ['Agregar', 'Agregar Todo'],
    },
    acciones: ['Nuevo', 'Eliminar', 'Imprimir', 'Guardar'],
  },
  cambiar_anio: {
    id: 'cambiar_anio',
    mod: 'Seguridad',
  ...
  auditoria: {
    ...
    filtros: [
      {
        ...
        label: 'Usuario',
        t: 'sel',
        opts: ['Todos', 'jcardenas', 'mrios', 'rmendoza', 'lpena'],
      },
      {
        clave: 'accion',
        label: 'Acción',
        t: 'sel',
        opts: ['Todas', 'ALTA', 'MODIFICACIÓN', 'ELIMINACIÓN', 'ANULACIÓN', 'ACCESO'],
      },
      {
        clave: 'desde',
        label: 'Desde',
    ...
    acciones: ['Excel', 'Imprimir bitácora'],
  },
  parametros: {
    id: 'parametros',
    mod: 'Seguridad',
    ...
    acciones: ['Deshacer', 'Guardar parámetros'],
  },
  respaldo: {
    id: 'respaldo',
    mod: 'Seguridad',
    ...
    filtros: [
      ...
      },
      {
        ...
        label: 'Tipo',
        t: 'sel',
        opts: ['Todos', 'DIARIA', 'MENSUAL', 'MANUAL'],
      },
    ],
    secciones: [
      {
    ...
    acciones: ['Restaurar', 'Ejecutar respaldo'],
  },
};
