...
export const RESPUESTAS: Readonly<Record<string, DatosDePantalla>> = {
  ...
  "ficha_urbana": {
    ...
    "campos": {
      ...
      "observaciones": "Ampliación del segundo piso verificada en inspección del 03/2026; pendiente de declaración jurada rectificatoria.",
  ...
  "baja_deuda": {
    ...
    "campos": {
      ...
      "motivo": "Prescripción declarada de los ejercicios 2014 a 2016 conforme al artículo 43º del Código Tributario."
    },
    "tabla": {
      "filas": [
        [
  ...
  "fisc_predial": {
    ...
    "campos": {
      ...
      "observacionesDelFiscalizador": "Segundo piso construido en 2011 destinado a bodega; no figura en la declaración jurada.",
  ...
  "transito_descargos": {
    ...
    "campos": {
      ...
      "fundamentoDelAdministrado": "Señala que el vehículo se encontraba detenido por desperfecto mecánico y adjunta constancia del taller.",
  ...
  "transito_documentos": {
    ...
    "campos": {
      ...
      "exped": "112",
      "fecExp": "2026-05-05",
      "infraccion": "F5 — NO PRESENTAR LA TARJETA DE IDENTIFICACIÓN VEHICULAR, LICENCIA DE CONDUCIR U OTRO DOCUMENTO DE IDENTIDAD",
  ...
  "transito_constancia_libre": {
    ...
    "reporte": {
      ...
      "filas": [
        ...
        [
          "Papeletas en cobranza coactiva",
          "2019 — 2026",
          "0",
          "Sin registros"
        ],
    ...
    "reporte": {
      ...
      "filas": [
        [
          ...
          "DS F1 — Conducir sin portar licencia",
          "—"
        ],
        [
          "Base imponible (UIT 2025)",
          "S/ 5,350.00",
          "5,350.00"
        ],
        [
          "% de la UIT por la infracción",
          "8 %",
          "428.00"
        ],
        [
        ...
        [
          "Importe a pagar con beneficio",
          "Descuento 70 % — pago dentro de 5 días",
          "42.60"
        ]
      ],
  ...
  "infracciones_adm": {
    ...
    "campos": {
      ...
      "seNegoAFirmar": true,
      "descripcionDeLosHechos": "Establecimiento comercial en funcionamiento sin contar con licencia municipal vigente.",
      "codigoCuis2": "C-101",
  ...
  "adm_resolucion_gerencia": {
    ...
    "reporte": {
      ...
      "filas": [
        [
          "Multa A-014 — funcionar sin licencia",
          "CUIS — Ordenanza Municipal 018-2024",
          "2,675.00"
        ],
        [
          "Interés moratorio",
          "Art. 33 Código Tributario",
          "138.60"
        ],
        [
          "Gastos administrativos",
  ...
  "adm_notificacion_resolucion": {
    ...
    "reporte": {
      ...
      "filas": [
        ...
        [
          "Recibido por",
          "REPRESENTANTE — RUIZ INGA, FERNANDO"
        ],
        [
        ...
        [
          ...
          "LOCAL COMERCIAL DE UN PISO, FACHADA DE LADRILLO"
        ],
        [
          "Notificador",
          "RETO SANTOS, VÍCTOR"
  ...
  "consulta_altas_bajas": {
    ...
    "campos": {
      ...
      "altaBaja": "(TODAS)",
      "autoManual": "(TODAS)",
      "observacion": "BAJA AUTOMÁTICA: POR NO CORRESPONDER DEUDA, DEUDA HA SIDO CANCELADA — PARQUES Y JARDINES — UNIDAD: 20",
      "tributo": "(TODOS)",
      "tipoAB": "(TODOS)"
    },
    "tabla": {
    ...
    "reporte": {
      ...
      "filas": [
        [
          ...
          "CESE DE ACTIVIDADES SOLICITADO POR EL TITULAR"
        ],
        [
          "Fecha de cese declarada",
          "31/07/2026"
        ],
        [
          "Expediente",
        ...
        [
          "Recibo de trámite",
          "000000049180 — S/ 36.00"
        ],
        [
          "Deuda pendiente por licencia",
          "S/ 0.00"
        ]
      ],
  ...
  "licencia_resolucion_duplicado": {
    ...
    "reporte": {
      ...
      "filas": [
        [
          "Motivo",
          "PÉRDIDA DEL ORIGINAL — DECLARACIÓN JURADA ADJUNTA"
        ],
        [
          "Expediente",
          "2026-004244"
