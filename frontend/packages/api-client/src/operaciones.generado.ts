 ...
 *
 * Las 176 operaciones del contrato como tipos: verbo, ruta, parametros y —cuando
 ...
 * fija verbo, ruta y parametros de las 176 operaciones, y **el esquema de cada
...
/**
 * Las 176 operaciones del contrato, por su `operationId`.
 *
 ...
 * backend. Ninguna de las 176 recibe la municipalidad — sale del token, y el
...
/** El `operationId` de una de las 176 operaciones. */
