...
export const OPERACIONES = {
  ...
  /** Mi situación en todas las municipalidades — `GET /portal/situacion` */
  portal_mi_situacion: {
    metodo: 'GET',
    ruta: '/portal/situacion',
    parametrosDeRuta: [],
  ...
  /** Alta de predio, sin ficha — `POST /catastro/predios` */
  inscribir_predio: {
    metodo: 'POST',
    ruta: '/catastro/predios',
    parametrosDeRuta: [],
  ...
  /** Estado de la ultima emision del ejercicio — `GET /rentas/predial/corridas/ultima` */
  ultima_corrida_predial: {
    metodo: 'GET',
    ruta: '/rentas/predial/corridas/ultima',
    parametrosDeRuta: [],
    parametrosDeConsulta: ['ejercicio'],
  },
  /** Los observados de una corrida — `GET /rentas/predial/corridas/{corridaId}/observados` */
  observados_de_la_corrida: {
    metodo: 'GET',
    ruta: '/rentas/predial/corridas/{corridaId}/observados',
    parametrosDeRuta: ['corridaId'],
    parametrosDeConsulta: [],
  },
  ...
  /** Programas de fiscalización — `GET /fiscalizacion/programas` */
  fisc_programas_listado: {
    metodo: 'GET',
    ruta: '/fiscalizacion/programas',
    parametrosDeRuta: [],
    parametrosDeConsulta: ['nDePrograma', 'ejercicio', 'pagina', 'tamano', 'ordenarPor', 'direccion'],
  },
  ...
  /** Muestra sorteada del programa — `GET /fiscalizacion/programas/{id}/muestra` */
  fisc_programa_muestra: {
    metodo: 'GET',
    ruta: '/fiscalizacion/programas/{id}/muestra',
    parametrosDeRuta: ['id'],
    parametrosDeConsulta: ['predio', 'pagina', 'tamano', 'ordenarPor', 'direccion'],
  },
  /** Generar la muestra del programa — `POST /fiscalizacion/programas/{id}/muestra` */
  fisc_programa_generar_muestra: {
    metodo: 'POST',
    ruta: '/fiscalizacion/programas/{id}/muestra',
    parametrosDeRuta: ['id'],
    parametrosDeConsulta: [],
  ...
  constancia: {
    ...
    parametrosDeRuta: [],
    parametrosDeConsulta: ['codContribuyente', 'fecha', 'formato'],
  },
  ...
  /** Deuda del expediente coactivo, obligación por obligación — `GET /coactiva/expedientes/{numero}/deuda` */
  coactiva_deuda_del_expediente: {
    metodo: 'GET',
    ruta: '/coactiva/expedientes/{numero}/deuda',
    parametrosDeRuta: ['numero'],
    parametrosDeConsulta: ['fechaDeCalculo'],
  },
...
export interface ParametrosPorOperacion {
  ...
  readonly portal_mi_situacion: Readonly<Record<string, never>>;
  ...
  readonly inscribir_predio: Readonly<Record<string, never>>;
  ...
  readonly ultima_corrida_predial: {
    readonly ejercicio?: string;
  };
  /** `GET /rentas/predial/corridas/{corridaId}/observados` */
  readonly observados_de_la_corrida: {
  ...
  readonly fisc_programas_listado: {
  ...
  readonly fisc_programa_muestra: {
    readonly id: string;
  ...
  readonly fisc_programa_generar_muestra: {
    readonly id: string;
  };
  ...
  readonly coactiva_deuda_del_expediente: {
    readonly numero: string;
    readonly fechaDeCalculo?: string;
  };
...
export interface CuerpoPorOperacion {
  ...
  readonly portal_mi_situacion: undefined;
  ...
  readonly ultima_corrida_predial: undefined;
  readonly observados_de_la_corrida: undefined;
  ...
  readonly fisc_programas_listado: undefined;
  readonly fisc_programa: CuerpoSinEsquema;
  readonly fisc_programa_muestra: undefined;
  readonly fisc_programa_generar_muestra: CuerpoSinEsquema;
  ...
  readonly coactiva_deuda_del_expediente: undefined;
...
export interface RespuestaPorOperacion {
  ...
  readonly portal_mi_situacion: CuerpoSinEsquema;
  ...
  readonly ultima_corrida_predial: CuerpoSinEsquema;
  readonly observados_de_la_corrida: CuerpoSinEsquema;
  readonly mudar_contribuyente: CuerpoSinEsquema;
  readonly registrar_contacto: CuerpoSinEsquema;
  readonly modificar_contacto: CuerpoSinEsquema;
  readonly registrar_responsable_solidario: CuerpoSinEsquema;
  ...
  readonly alta_deuda: CuerpoSinEsquema;
  readonly baja_deuda: CuerpoSinEsquema;
  readonly fisc_programas_listado: CuerpoSinEsquema;
  readonly fisc_programa: CuerpoSinEsquema;
  readonly fisc_programa_muestra: CuerpoSinEsquema;
  readonly fisc_programa_generar_muestra: CuerpoSinEsquema;
  readonly fisc_predial: CuerpoSinEsquema;
  readonly fisc_vehicular: CuerpoSinEsquema;
  ...
  readonly costas_procesales: CuerpoSinEsquema;
  readonly coactiva_deuda_del_expediente: CuerpoSinEsquema;
  readonly fraccionamiento_coactivo: CuerpoSinEsquema;
  readonly actos_coactivos: CuerpoSinEsquema;
  readonly notificaciones_coactivas: CuerpoSinEsquema;
